...
//                                                case "Details":
//                                                    Menu men = new Menu();
//                                                    Log.Logger.Information("Updating details table..");
//                                                    Models.Details det = new Models.Details();
//                                                    det = efobj.GetDetails(id);
//                                                    string useropt = men.updateDetailsChoice();
//                                                    switch(useropt)
//                                                    {
//                                                        case "Update Address":
//                                                            Console.WriteLine("Your current Address : "+det.Address);
//                                                            efobj.UpdateDetails(det, "Address");
//                                                            break;
//                                                    }
//                                                    break;
//                                            }
